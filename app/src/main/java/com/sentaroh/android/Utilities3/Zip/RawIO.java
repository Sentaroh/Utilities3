...
public class RawIO {
  ...
  public long readLongLittleEndian(SeekableInputStream randomAccessFile) throws IOException {
    randomAccessFile.readFully(longBuff);
    return readLongLittleEndian(longBuff, 0);
  }

  public long readLongLittleEndian(SeekableInputStream randomAccessFile, int readLen) throws IOException {
    resetBytes(longBuff);
  ...
  public int readIntLittleEndian(SeekableInputStream randomAccessFile) throws IOException {
  ...
  public int readShortLittleEndian(SeekableInputStream randomAccessFile) throws IOException {
