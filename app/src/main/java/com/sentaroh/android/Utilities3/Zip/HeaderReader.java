...
/*
*
* 2019/12/23 Change RandamAccessFile to SeejableInputStream. by F.Hoshino
*
*
*/
...
public class HeaderReader {
  ...
  public ZipModel readAllHeaders(SeekableInputStream zip4jRaf, Charset charset) throws IOException {
  ...
  private CentralDirectory readCentralDirectory(SeekableInputStream zip4jRaf, RawIO rawIO, Charset charset) throws IOException {
  ...
  private void readExtraDataRecords(SeekableInputStream zip4jRaf, FileHeader fileHeader)
      throws IOException {
  ...
  private List<ExtraDataRecord> readExtraDataRecords(SeekableInputStream zip4jRaf, int extraFieldLength)
      throws IOException {
  ...
  private Zip64EndOfCentralDirectoryLocator readZip64EndOfCentralDirectoryLocator(SeekableInputStream zip4jRaf,
  ...
  private Zip64EndOfCentralDirectoryRecord readZip64EndCentralDirRec(SeekableInputStream zip4jRaf, RawIO rawIO)
      throws IOException {
  ...
  private void setFilePointerToReadZip64EndCentralDirLoc(SeekableInputStream zip4jRaf, RawIO rawIO) throws IOException {
    long pos = zip4jRaf.length() - ENDHDR;
